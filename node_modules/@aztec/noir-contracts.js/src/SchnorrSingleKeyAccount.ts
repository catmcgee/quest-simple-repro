...
export const SchnorrSingleKeyAccountContractArtifact = loadContractArtifact(SchnorrSingleKeyAccountContractArtifactJson as NoirCompiledContract);
...
export class SchnorrSingleKeyAccountContract extends ContractBase {
  ...
  public static async at(
    ...
    return Contract.at(address, SchnorrSingleKeyAccountContract.artifact, wallet) as Promise<SchnorrSingleKeyAccountContract>;
  }
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<SchnorrSingleKeyAccountContract>(PublicKeys.default(), wallet, SchnorrSingleKeyAccountContractArtifact, SchnorrSingleKeyAccountContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<SchnorrSingleKeyAccountContract>(publicKeys, wallet, SchnorrSingleKeyAccountContractArtifact, SchnorrSingleKeyAccountContract.at, Array.from(arguments).slice(2));
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(SchnorrSingleKeyAccountContractArtifactJson as NoirCompiledContract);
  }
