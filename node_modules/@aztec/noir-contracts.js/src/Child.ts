...
export class ChildContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<ChildContract>(PublicKeys.default(), wallet, ChildContractArtifact, ChildContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<ChildContract>(publicKeys, wallet, ChildContractArtifact, ChildContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof ChildContract['methods']>(
    opts: { publicKeys?: PublicKeys; method?: M; wallet: Wallet },
    ...args: Parameters<ChildContract['methods'][M]>
  ) {
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(ChildContractArtifactJson as NoirCompiledContract);
  }
