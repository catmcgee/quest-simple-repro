...
export class ImportTestContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<ImportTestContract>(PublicKeys.default(), wallet, ImportTestContractArtifact, ImportTestContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<ImportTestContract>(publicKeys, wallet, ImportTestContractArtifact, ImportTestContract.at, Array.from(arguments).slice(2));
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(ImportTestContractArtifactJson as NoirCompiledContract);
  }
  

  

  public static get notes(): ContractNotes<'ValueNote' | 'AddressNote' | 'TestNote'> {
    return {
      ValueNote: {
...
TestNote: {
    ...
    } as ContractNotes<'ValueNote' | 'AddressNote' | 'TestNote'>;
  }
