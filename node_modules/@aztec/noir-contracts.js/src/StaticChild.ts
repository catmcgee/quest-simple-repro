...
export const StaticChildContractArtifact = loadContractArtifact(StaticChildContractArtifactJson as NoirCompiledContract);
...
export class StaticChildContract extends ContractBase {
  ...
  public static async at(
    ...
    return Contract.at(address, StaticChildContract.artifact, wallet) as Promise<StaticChildContract>;
  }
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<StaticChildContract>(PublicKeys.default(), wallet, StaticChildContractArtifact, StaticChildContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<StaticChildContract>(publicKeys, wallet, StaticChildContractArtifact, StaticChildContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof StaticChildContract['methods']>(
    opts: { publicKeys?: PublicKeys; method?: M; wallet: Wallet },
    ...args: Parameters<StaticChildContract['methods'][M]>
  ) {
    return new DeployMethod<StaticChildContract>(
      opts.publicKeys ?? PublicKeys.default(),
      opts.wallet,
      StaticChildContractArtifact,
      StaticChildContract.at,
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(StaticChildContractArtifactJson as NoirCompiledContract);
  }
...
a_private_value: {
  ...
  public declare methods: {
    ...
    /** private_set_value(new_value: field, owner: struct, sender: struct) */
    private_set_value: ((new_value: FieldLike, owner: AztecAddressLike, sender: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
