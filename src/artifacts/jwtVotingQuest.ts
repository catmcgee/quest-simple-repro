...
import jwtVotingQuestContractArtifactJson from '../../contract/target/contract-jwtVotingQuest.json' with { type: 'json' };
...
quest_winner: {
  ...
  public declare methods: {
    ...
    /** cast_vote_simple(identifier: field, candidate: field) */
    cast_vote_simple: ((identifier: FieldLike, candidate: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
