...
export class ClaimContract extends ContractBase {
   ...
   */
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, target_contract: AztecAddressLike, reward_token: AztecAddressLike) {
...
reward_token: {
  ...
  public declare methods: {
    ...
    /** claim(proof_retrieved_note: struct, recipient: struct) */
    claim: ((proof_retrieved_note: { note: { owner: AztecAddressLike, randomness: FieldLike, value: (bigint | number) }, contract_address: AztecAddressLike, metadata: { stage: (bigint | number), maybe_nonce: FieldLike } }, recipient: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
