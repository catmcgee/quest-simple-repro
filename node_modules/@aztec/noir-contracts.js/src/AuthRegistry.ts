...
export class AuthRegistryContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<AuthRegistryContract>(PublicKeys.default(), wallet, AuthRegistryContractArtifact, AuthRegistryContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<AuthRegistryContract>(publicKeys, wallet, AuthRegistryContractArtifact, AuthRegistryContract.at, Array.from(arguments).slice(2));
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(AuthRegistryContractArtifactJson as NoirCompiledContract);
  }
...
approved_actions: {
  ...
  public declare methods: {
    ...
    utility_is_consumable: ((on_behalf_of: AztecAddressLike, message_hash: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
  };
