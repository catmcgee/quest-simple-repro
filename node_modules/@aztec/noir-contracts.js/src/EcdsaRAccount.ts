...
import EcdsaRAccountContractArtifactJson from '../artifacts/ecdsa_r_account_contract-EcdsaRAccount.json' assert { type: 'json' };
export const EcdsaRAccountContractArtifact = loadContractArtifact(EcdsaRAccountContractArtifactJson as NoirCompiledContract);



/**
 * Type-safe interface for contract EcdsaRAccount;
 */
export class EcdsaRAccountContract extends ContractBase {
  
  private constructor(
    instance: ContractInstanceWithAddress,
    wallet: Wallet,
  ) {
    super(instance, EcdsaRAccountContractArtifact, wallet);
  }
  ...
  public static async at(
    ...
    return Contract.at(address, EcdsaRAccountContract.artifact, wallet) as Promise<EcdsaRAccountContract>;
  }
  ...
  public static deploy(wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]) {
    return new DeployMethod<EcdsaRAccountContract>(PublicKeys.default(), wallet, EcdsaRAccountContractArtifact, EcdsaRAccountContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, signing_pub_key_x: (bigint | number)[], signing_pub_key_y: (bigint | number)[]) {
    return new DeployMethod<EcdsaRAccountContract>(publicKeys, wallet, EcdsaRAccountContractArtifact, EcdsaRAccountContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof EcdsaRAccountContract['methods']>(
    opts: { publicKeys?: PublicKeys; method?: M; wallet: Wallet },
    ...args: Parameters<EcdsaRAccountContract['methods'][M]>
  ) {
    return new DeployMethod<EcdsaRAccountContract>(
      opts.publicKeys ?? PublicKeys.default(),
      opts.wallet,
      EcdsaRAccountContractArtifact,
      EcdsaRAccountContract.at,
  ...
  public static get artifact(): ContractArtifact {
    return EcdsaRAccountContractArtifact;
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(EcdsaRAccountContractArtifactJson as NoirCompiledContract);
  }
