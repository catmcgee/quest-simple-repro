...
export class AuthContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, admin: AztecAddressLike) {
    return new DeployMethod<AuthContract>(PublicKeys.default(), wallet, AuthContractArtifact, AuthContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, admin: AztecAddressLike) {
    return new DeployMethod<AuthContract>(publicKeys, wallet, AuthContractArtifact, AuthContract.at, Array.from(arguments).slice(2));
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(AuthContractArtifactJson as NoirCompiledContract);
  }
