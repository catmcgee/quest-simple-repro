...
export const FeeJuiceContractArtifact = loadContractArtifact(FeeJuiceContractArtifactJson as NoirCompiledContract);
...
export class FeeJuiceContract extends ContractBase {
  ...
  public static async at(
    ...
    return Contract.at(address, FeeJuiceContract.artifact, wallet) as Promise<FeeJuiceContract>;
  }
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<FeeJuiceContract>(PublicKeys.default(), wallet, FeeJuiceContractArtifact, FeeJuiceContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<FeeJuiceContract>(publicKeys, wallet, FeeJuiceContractArtifact, FeeJuiceContract.at, Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof FeeJuiceContract['methods']>(
    opts: { publicKeys?: PublicKeys; method?: M; wallet: Wallet },
    ...args: Parameters<FeeJuiceContract['methods'][M]>
  ) {
    return new DeployMethod<FeeJuiceContract>(
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(FeeJuiceContractArtifactJson as NoirCompiledContract);
  }
