...
export const MultiCallEntrypointContractArtifact = loadContractArtifact(MultiCallEntrypointContractArtifactJson as NoirCompiledContract);
...
export class MultiCallEntrypointContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, ) {
    return new DeployMethod<MultiCallEntrypointContract>(PublicKeys.default(), wallet, MultiCallEntrypointContractArtifact, MultiCallEntrypointContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, ) {
    return new DeployMethod<MultiCallEntrypointContract>(publicKeys, wallet, MultiCallEntrypointContractArtifact, MultiCallEntrypointContract.at, Array.from(arguments).slice(2));
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(MultiCallEntrypointContractArtifactJson as NoirCompiledContract);
  }
  ...
  public declare methods: {
    ...
    entrypoint: ((app_payload: { function_calls: { args_hash: FieldLike, function_selector: FunctionSelectorLike, target_address: AztecAddressLike, is_public: boolean, is_static: boolean }[], nonce: FieldLike }) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
